<?php 
	...
	class Usuario{
		...
		public function crearUsuario(){
			...
			$con = new Conexion();
			return $con->enviar ( "insert into etusuario (usuario,contrasena,permisos,estado) values (:usuario,:contrasena,:permisos,:estado)",
		...
		public function extraerUsuario(){
			...
			return $con->extraer('select * from etusuario where usuario = :usuario',array('usuario'=>$this->getUsuario()));
